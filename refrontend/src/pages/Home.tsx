...
const Home = () => {
  ...
  const whyChooseUs = [
    { icon: <Users className="w-16 h-16" />, title: 'Staffing', desc: 'NetBounce Placement excels in IT recruitment and staffing services for finance, healthcare, and technology sectors.' },
    { icon: <GraduationCap className="w-16 h-16" />, title: 'Career Guidance', desc: 'Discover your professional compass with NetBounce Placement. Our career guidance offers insights, trends, and tailored advice.' },
    { icon: <Users className="w-16 h-16" />, title: 'Job Guarantee', desc: 'NetBounce Placement stands out by offering job guarantee plans, providing job seekers with the confidence they need.' }
  ]
  ...
  const testimonials = [
    { name: 'Enock Brookins', role: 'DevOps Engineer', content: 'I have been consistently impressed with the NetBounce team\'s attitude since the first day they contacted me for a position as a Consultant.', img: 'Enock-Brookins.png' },
    { name: 'Priya Patel', role: 'Business Analyst', content: 'My overall feedback is that he exceeded expectations. He made the hiring process really smooth and answered to all my queries.', img: 'Priya-Patel.png' },
    { name: 'Vaidehi Shah', role: 'Project Manager', content: 'You always find a way to do fantastic work. I would sincerely like to express my thanks to NetBounce in the successful placement.', img: 'Vaidehi-Shah.png' }
  ]
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <p className="text-[#FD6F2F] font-semibold mb-2 text-base">NetBounce Placement's</p>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2F3E2E] mb-6">Services</h2>
              <p className="text-gray-600 mb-6 text-base leading-relaxed">NetBounce Placement provides a holistic range of IT services. From job placement and career guidance to interview support, training, and staffing solutions, we're your partners in every step of your IT journey.</p>
        ...
        <div className="relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10 md:mb-16">
              <p className="text-base md:text-lg mb-2">Give your Job Seekness to NetBounce</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-gradient-to-br from-[#FFEAD1] to-white p-8 md:p-10 rounded-2xl">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#2F3E2E] mb-6">Let NetBounce, Find you the right job</h2>
              <p className="text-gray-600 mb-4 text-base leading-relaxed">As the flagship of innovation in the placement industry, NetBounce Placement brings a distinct approach to the forefront. With a foundation deeply rooted in cutting-edge strategies, we specialize in delivering customized staffing solutions.</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-gray-600 mb-8 text-base leading-relaxed">Since its establishment, NetBounce Placement has facilitated the successful placement of 870+ candidates, underscoring our proficiency in generating meaningful employment opportunities.</p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg">
                ...
                <p className="text-gray-600 text-sm">NetBounce has achieved a {stats.rate}% placement success rate since the start of its operations.</p>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <img src="/success.jpg" alt="Success" className="w-full rounded-lg" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop' }} />
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="relative">
            <div className="flex animate-scroll">
              {[...companies, ...companies].map((company, i) => (
                <img key={i} src={`/images/${company}`} alt="Company" className="h-20 mx-8 transition flex-shrink-0" onError={(e) => { e.currentTarget.style.display = 'none' }} />
              ))}
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <img src="/tpartner1.jpg" alt="About Company" className="w-full rounded-lg shadow-xl" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1600880292089-90a7e086ee0c?w=800&h=600&fit=crop' }} />
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-gray-600 mb-6 text-base leading-relaxed">NetBounce Placement stands out as a premier job-seeking service, distinguished by our extensive nationwide searches within the United States. Our mission is to identify the most suitable candidates for a wide range of job roles.</p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="flex justify-center">
              <img src="/companyvision.jpg" alt="Vision" className="w-full max-w-md rounded-lg shadow-lg" onError={(e) => { e.currentTarget.src = 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=600&fit=crop' }} />
            </motion.div>
          </div>
        </div>
      </section>
            ...
            <div className="flex transition-transform duration-500" style={{ transform: `translateX(-${currentTestimonial * 100}%)` }}>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-4">
                  <div className="bg-white p-6 md:p-8 rounded-xl md:rounded-2xl shadow-lg max-w-2xl mx-auto">
                    <div className="flex items-center gap-3 md:gap-4 mb-4">
                      <img src={`/images/${testimonial.img}`} alt={testimonial.name} className="w-12 h-12 md:w-16 md:h-16 rounded-full" onError={(e) => { e.currentTarget.src = 'https://ui-avatars.com/api/?name=' + testimonial.name }} />
                      <div>
                        <div className="font-bold text-[#2F3E2E] text-sm md:text-base">{testimonial.name}</div>
                        <div className="text-xs md:text-sm text-gray-600">{testimonial.role}</div>
                      </div>
                    </div>
                    <div className="flex gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <svg key={i} className="w-4 h-4 md:w-5 md:h-5 fill-[#FD6F2F] text-[#FD6F2F]" viewBox="0 0 20 20"><path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/></svg>
                      ))}
                    </div>
