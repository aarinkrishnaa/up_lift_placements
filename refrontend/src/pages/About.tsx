    ...
    <div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-6">
            UP LIFT PLACEMENTS stands out as a premier job-seeking service, distinguished by our extensive nationwide searches within the United States. Our mission is to identify the most suitable candidates for a wide range of job roles.
          </p>
          <p className="text-gray-700 leading-relaxed mb-6">
            As the flagship of innovation in the placement industry, UP LIFT PLACEMENTS brings a distinct approach to the forefront. With a foundation deeply rooted in cutting-edge strategies, we specialize in delivering customized staffing solutions.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-700 leading-relaxed mb-8 text-center max-w-4xl mx-auto">
            Since its establishment, UP LIFT PLACEMENTS has facilitated the successful placement of 870+ candidates, underscoring our proficiency in generating meaningful employment opportunities.
          </p>
          ...
          <div className="bg-gradient-to-br from-[#FFEAD1] to-white p-6 rounded-2xl shadow-lg max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-center">UP LIFT PLACEMENTS has achieved a 97.8% placement success rate since the start of its operations.</p>
          </div>
        </div>
      </section>
